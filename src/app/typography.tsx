import { standardText, mutedText, mutedBg } from './twStrings';
...
function TypographyBlockquote({
    ...
    return (
        <blockquote
            {...props}
            className={cn(
                `mt-6 border-l-2 pl-6 italic ${standardText}`,
                className
            )}
        />
    );
...
function TypographyList({ className, ...props }: React.ComponentProps<`ul`>) {
    return (
        <ul
            {...props}
            className={cn(
                `list-disc ${standardText} font-Avenir-medium`,
                className
            )}
        />
    );
...
function TypographyListItem({
    ...
    return (
        <li
            {...props}
            className={cn(
                `leading-7 ${mutedText} text-sm ml-6 my-1`,
                className
            )}
        />
    );
...
function TypographyLarge({ className, ...props }: React.ComponentProps<`div`>) {
    return (
        <div
            {...props}
            className={cn(
                `text-lg font-Avenir-heavy ${standardText}`,
                className
            )}
        />
    );
